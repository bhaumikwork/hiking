Rails.application.routes.draw do
  ...
  resources :events do
    ...
    member do
      ...
      get 'edit_picture_plan'
      put 'picture_plan' => 'events#update_picture_plan', as: :update_picture_plan
      get 'plan_itinerary'
      post 'save_plan_itinerary'
      get 'edit_plan_itinerary'
      put 'plan_itinerary' => 'events#update_plan_itinerary', as: :update_plan_itinerary
      get 'gallery'
      post 'save_gallery'
      get 'edit_gallery'
      put 'gallery' => 'events#update_gallery', as: :update_gallery
      get 'other_info'
      post 'save_other_info'
      get 'edit_other_info'
      put 'other_info' => 'events#update_other_info', as: :update_other_info
      get 'review_info'
